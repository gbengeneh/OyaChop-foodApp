...
$user_id = 2; // Assuming a user ID, replace this with your desired user ID handling logic
$user_id = intval($user_id);

$query = "SELECT tbl_food.food_id, tbl_food.title, tbl_food.image_name, status, total, order_date
          FROM orders
          INNER JOIN tbl_food ON orders.food_id = tbl_food.food_id
