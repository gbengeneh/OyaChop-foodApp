...
if (!isset($_POST['firstname'], $_POST['lastname'], $_POST['gender'], $_POST['phone_number'], $_POST['email'], $_POST['delivery_address'], $_POST['password'], $_FILES['picture'])) {
...
if ($result) {
    ...
    $response = json_encode(['status' => 'error', 'code' => '440', 'message' => 'Error Occurred, Please Try Again!']);
    echo $response;
    return;
}
